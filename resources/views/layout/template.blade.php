...
<body>
	...
	<div class="header-info">
		<div class="container">
			<div class="header-top-in">
				...
				<ul class="support">
					<li><a href="#"><i class="fab fa-whatsapp-square"></i>Whatsapp</a></li>
				</ul>
	...
	<div class="header @yield('header5')">
		<div class="header-top">
			...
			<div class="header-bottom">
				<div class="container">
					<div class="logo">
						<h1><a href="index.html">National Badminton<span style="color: black;"> Field</span></a></h1>
					</div>
					<!---->
	...
	<div class="footer">
		<div class="container">
			<div class="clearfix"> </div>
			<p class="footer-class">Copyrights © 2024 National Badminton Field. All rights reserved</p>
		</div>
	</div>
	<!---->
