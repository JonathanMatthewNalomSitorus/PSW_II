            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.lapangan.store') }}" id="div-container" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-4 col-form-label">Tempat</label>
                            <div class="col-sm-8">
                        ...
                        <div class="mb-3 row">
                            <label for="foto1" class="col-sm-4 col-form-label">Foto</label>
                            <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.lapangan.edit') }}" id="edit-form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="edit_keterangan" class="col-sm-4 col-form-label">Tempat</label>
                            <div class="col-sm-8">
                        ...
                        <div class="mb-3 row">
                            <label for="edit_foto1" class="col-sm-4 col-form-label">Foto</label>
                            <div class="col-sm-8">
